---
title: "SaveFavoriteFileDialogImpl"
source: "PythonPartsFramework\GeneralScripts\DialogTypes\SaveFavoriteFileDialogImpl.py"
type: "class"
...
> **Pfad:** `PythonPartsFramework\GeneralScripts\DialogTypes\SaveFavoriteFileDialogImpl.py`  
> **Typ:** Klasse/Modul  
> **Tags:** `dialog`, `script`

## Übersicht

implementation of the save favorite file dialog
...
class SaveFavoriteFileDialogImpl(FileDialog):
    """ implementation of the save favorite file dialog
    """
    ...
    def show(build_ele      : BuildingElement,
        ...
        if (index := SaveFavoriteFileDialogImpl.get_index(build_ele, value_ctrl_prop, name)) is None:
            prop.value = AllplanUtil.FileDialog.AskSaveFavoriteFile(prop.value, value_ctrl_prop.text,
                                                                    value_ctrl_prop.value_list, value_ctrl_prop.value_list.split("|")[0])
        else:
            prop.value[index] = \
                AllplanUtil.FileDialog.AskSaveFavoriteFile(prop.value[index], value_ctrl_prop.text,
                                                           value_ctrl_prop.value_list, value_ctrl_prop.value_list.split("|")[0])
