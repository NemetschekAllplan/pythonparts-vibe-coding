---
title: "HatchImpl"
source: "PythonPartsFramework\GeneralScripts\ValueTypes\Resources\HatchImpl.py"
type: "class"
...
> **Pfad:** `PythonPartsFramework\GeneralScripts\ValueTypes\Resources\HatchImpl.py`  
> **Typ:** Klasse/Modul  
> **Tags:** `script`, `werte`

## Übersicht

implementation of the Hatch value type
...
|---|---|---|---|
| `get_value` | `value_str: str` | `list[int] | int` | get the hatch from a string  Args:     value_str: value string  Returns:     value from string |
...
class HatchImpl(BaseIntImpl):
    """ implementation of the Hatch value type
    """

    @staticmethod
    def get_value(value_str: str) -> (list[int] | int):
        """ get the hatch from a string
        ...
        if value_str == GeneralConstants.USE_CURRENT_RESOURCE_VALUE:
            return AllplanSettings.AllplanGlobalSettings.GetCurrentHatchId()
