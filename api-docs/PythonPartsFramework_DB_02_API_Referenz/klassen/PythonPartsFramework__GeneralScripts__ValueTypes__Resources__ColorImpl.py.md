---
title: "ColorImpl"
source: "PythonPartsFramework\GeneralScripts\ValueTypes\Resources\ColorImpl.py"
type: "class"
...
> **Pfad:** `PythonPartsFramework\GeneralScripts\ValueTypes\Resources\ColorImpl.py`  
> **Typ:** Klasse/Modul  
> **Tags:** `script`, `werte`
...
|---|---|---|---|
| `get_value` | `value_str: str` | `list[int] | int` | get the color from a string  Args:     value_str: value string  Returns:     value from string |
